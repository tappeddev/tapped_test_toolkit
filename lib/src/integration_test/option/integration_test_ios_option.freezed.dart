...
mixin _$IntegrationTestIosOption {
  ...
  $IntegrationTestIosOptionCopyWith<IntegrationTestIosOption> get copyWith =>
      _$IntegrationTestIosOptionCopyWithImpl<IntegrationTestIosOption>(
          this as IntegrationTestIosOption, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IntegrationTestIosOption &&
...
abstract mixin class $IntegrationTestIosOptionCopyWith<$Res> {
  factory $IntegrationTestIosOptionCopyWith(IntegrationTestIosOption value,
          $Res Function(IntegrationTestIosOption) _then) =
...
extension IntegrationTestIosOptionPatterns on IntegrationTestIosOption {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IntegrationTestIosOption value)? $default, {
...
class _IntegrationTestIosOption extends IntegrationTestIosOption {
  const _IntegrationTestIosOption(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IntegrationTestIosOptionCopyWith<_IntegrationTestIosOption> get copyWith =>
      __$IntegrationTestIosOptionCopyWithImpl<_IntegrationTestIosOption>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IntegrationTestIosOption &&
            (identical(other.browserstackUsername, browserstackUsername) ||
                other.browserstackUsername == browserstackUsername) &&
            (identical(other.browserstackAccessKey, browserstackAccessKey) ||
                other.browserstackAccessKey == browserstackAccessKey) &&
...
/// @nodoc
abstract mixin class _$IntegrationTestIosOptionCopyWith<$Res>
    implements $IntegrationTestIosOptionCopyWith<$Res> {
  factory _$IntegrationTestIosOptionCopyWith(_IntegrationTestIosOption value,
          $Res Function(_IntegrationTestIosOption) _then) =
      __$IntegrationTestIosOptionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String browserstackUsername,
